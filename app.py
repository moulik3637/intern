...
import pymysql.cursors  # uses PyMySQL backend
import os

app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY')  # no fallback
...
# View or Assign Tasks to Intern
